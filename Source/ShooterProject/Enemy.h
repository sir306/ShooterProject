...
UCLASS()
class SHOOTERPROJECT_API AEnemy : public ACharacter, public IBulletHitInterface
{
	GENERATED_BODY()
...
protected:
	...
	/** Enemy health bar functions called in blueprint and c++ */
...
private:
	...
	/** Chance of being stunned. 0: no stun chance, 1: 100% chance of stun */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	float StunChance;
