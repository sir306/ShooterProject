...
AItem::AItem():
	...
	ZCurveTime(0.7f),
	ItemIterpStartLocation(FVector(0.0f)),
	CameraTargetLoacation(FVector(0.0f)),
	bInterping(false),
	ItemInterpX(0.0f),
	ItemInterpY(0.0f),
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		// Vector from the Item to the Camera Interp Location, X and Y are zeroed out
...
FVector AItem::GetInterpLocation()
{
	...
	case EItemType::EIT_Ammo:
		return Character->GetInterpLocation(InterpLocIndex).SceneComponet->GetComponentLocation();
		break;
...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound)
{
	...
	// Add 1 to the Item Count for this interp loaction struct
	Character->IncrementInterpLocItemCount(InterpLocIndex, 1);
